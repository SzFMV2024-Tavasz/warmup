...
The project was migrated to dotnet 6 by [Siposattila](https://github.com/Siposattila).

The migrated project was not fully tested but it seems like its working!
If you are using linux then you may need to install `libgdiplus`.
